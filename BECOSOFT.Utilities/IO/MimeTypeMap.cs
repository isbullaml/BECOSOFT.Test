...
namespace BECOSOFT.Utilities.IO {
    /// <summary>
    /// Original code: <see href="https://github.com/samuelneff/MimeTypeMap"/>
    /// </summary>
    public static class MimeTypeMap {
        ...
        public static string GetMimeType(string extension) {
            ...
            return Mappings.Value.TryGetValue(extension.ToLower(), out var mime) ? mime : "application/octet-stream";
        }
        ...
        public static bool IsExtension(string extension) {
            ...
            return Mappings.Value.ContainsKey(extension.ToLower());
        }
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound) {
            ...
            if (Mappings.Value.TryGetValue(mimeType.ToLower(), out var extension)) {
                return extension;
            }
