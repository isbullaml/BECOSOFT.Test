// Based on: https://github.com/dotnet/runtime/blob/master/src/libraries/System.Private.CoreLib/src/System/Globalization/ISOWeek.cs
...
namespace BECOSOFT.Utilities.Models {
    public static class ISOWeek {
        ...
        public static int GetWeeksInYear(int year) {
            ...
            Func<int, int> P = (int y) => (y + (y / 4) - (y / 100) + (y / 400)) % 7;
