...
namespace BECOSOFT.Utilities.Barcode {
    public class Ean13 : Barcode, IBarcode, IChecksummable, IBarcodeNumberSeriesEnabled {
        public override BarcodeType Type => BarcodeType.Ean13;

        /// <summary>
        /// The length of an EAN13-barcode
        /// </summary>
        public static readonly int Length = 13;
        /// <summary>
        /// The length of an EAN13-barcode without the check digit
        /// </summary>
